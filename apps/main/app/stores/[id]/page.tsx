    ...
    if (storeError || !store) {
        return (
            <div className="min-h-screen bg-[#301118] flex flex-col items-center justify-center p-6 text-center">
                ...
                <h1 className="text-3xl font-bold text-white mb-4" style={fontStyle}>{t.notFound.title}</h1>
                <p className="text-gray-400 mb-8" style={fontStyle}>{t.notFound.desc}</p>
                <Link href="/" className="px-8 py-4 bg-orange text-white rounded-2xl font-bold uppercase tracking-widest hover:bg-orange/90 transition-all" style={fontStyle}>
                    {t.notFound.btnBack}
                </Link>
            </div>
        );
                        ...
                        <div className="bg-gradient-to-b from-[#fff7f0] to-white rounded-[40px] overflow-hidden shadow-premium border border-slate-100 transition-all duration-500 hover:shadow-2xl hover:border-orange/30 group">
                            <div className="relative pt-10 pb-4 flex flex-col items-center">
                                ...
                                <div className="absolute top-6 right-8 bg-orange/10 text-orange px-4 py-1.5 rounded-full flex items-center gap-2 border border-orange/20 shadow-sm">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-widest" style={fontStyle}>{t.profile.verifiedSeller}</span>
                                </div>
                                ...
                                <div className="absolute top-6 left-8">
                                    {isOnline ? (
                                        <div className="flex items-center gap-1.5 px-3 py-1.5 bg-green-500/10 backdrop-blur-md rounded-full border border-green-500/20 animate-in fade-in slide-in-from-left-4 duration-500">
                                            ...
                                            <span className="text-[9px] font-black text-green-600 uppercase tracking-widest leading-none" style={fontStyle}>{t.profile.online}</span>
                                        </div>
                                    ) : (
                                        <div className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-500/10 backdrop-blur-md rounded-full border border-slate-500/20">
                                            ...
                                            <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest leading-none" style={fontStyle}>{t.profile.offline}</span>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="mt-6 text-center px-8 space-y-3">
                                    <h2 className="text-3xl font-black text-slate-900 tracking-tighter uppercase leading-tight" style={fontStyle}>{shop.name}</h2>
                                    ...
                                    <div className="flex items-center justify-center gap-1.5 text-orange font-black bg-orange/5 px-3 py-1 rounded-full text-[10px] uppercase tracking-widest border border-orange/10 mx-auto w-fit">
                                        ...
                                        <span style={fontStyle}>{shop.city} {t.profile.marketplace}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mx-6 p-4 bg-white rounded-3xl flex justify-between items-center border border-slate-100 shadow-premium group-hover:border-orange/10 transition-colors">
                                <div className="text-center px-4">
                                    <p className="text-[9px] uppercase tracking-[0.2em] text-slate-400 font-black mb-1" style={fontStyle}>{t.profile.est}</p>
                                    <p className="text-sm font-black text-slate-900" style={fontStyle}>{shop.established || t.profile.na}</p>
                                </div>
                                <div className="h-10 w-px bg-slate-100"></div>
                                <div className="text-center px-4">
                                    <p className="text-[9px] uppercase tracking-[0.2em] text-slate-400 font-black mb-1" style={fontStyle}>{t.profile.rating}</p>
                                    <div className="flex items-center justify-center gap-1">
                                        <span className="text-sm font-black text-slate-900" style={fontStyle}>{shop.rating || "0"}</span>
                                        <Star className="w-3.5 h-3.5 text-orange fill-orange" />
                                    </div>
                                </div>
                                <div className="h-10 w-px bg-slate-100"></div>
                                <div className="text-center px-4">
                                    <p className="text-[9px] uppercase tracking-[0.2em] text-slate-400 font-black mb-1" style={fontStyle}>{t.profile.products}</p>
                                    <div className="flex items-center justify-center gap-1">
                                        <span className="text-sm font-black text-slate-900" style={fontStyle}>{shop.productsCount || (storeProducts as any[]).length || "0"}</span>
                                ...
                                <div className="flex items-center gap-4 group/item">
                                   <div className="w-10 h-10 rounded-2xl bg-[#FDF8F4] flex items-center justify-center text-orange group-hover/item:bg-orange group-hover/item:text-white transition-all duration-300">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest" style={fontStyle}>{t.trustInfo.scoreLabel}</span>
                                        <span className="text-sm font-black text-slate-800" style={fontStyle}>{shop.trustScore ? `${shop.trustScore}%` : "99.8%"} {t.trustInfo.reliability}</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 group/item">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest" style={fontStyle}>{t.trustInfo.hoursLabel}</span>
                                        <span className="text-sm font-black text-slate-800" style={fontStyle}>{shop.operationalHours || "10:00 AM - 08:30 PM"}</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 group/item">
                                    <div className="w-10 h-10 rounded-2xl bg-[#FDF8F4] flex items-center justify-center text-orange group-hover/item:bg-orange group-hover/item:text-white transition-all duration-300 border border-orange/5">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest" style={fontStyle}>{t.trustInfo.addressLabel}</span>
                                        <span className="text-sm font-black text-slate-800 line-clamp-1" style={fontStyle}>{shop.address}, {shop.city}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center justify-between border-b border-orange/10 pb-6 mb-8 gap-4">
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                         <h4 className="text-3xl font-black text-slate-900 uppercase tracking-tight" style={fontStyle}>{t.merchantDossier.title}</h4>
                                         <BadgeCheck className="w-6 h-6 text-orange fill-orange/10" />
                                    </div>
                                    <p className="text-gray-400 text-xs font-bold uppercase tracking-widest leading-none" style={fontStyle}>{t.merchantDossier.subtitle}</p>
                                </div>
                                <div className="flex items-center gap-3 bg-white/50 backdrop-blur-md px-4 py-2 rounded-2xl border border-orange/5">
                                    <Heart className="w-4 h-4 text-red-500 fill-red-500" />
                                    <span className="text-sm font-black text-slate-800 tracking-tight" style={fontStyle}>{shop.likesCount || "0"} {t.profile.likes}</span>
                                </div>
                            </div>
                            ...
                            <div className="sticky top-[110px] z-40 bg-white py-6 mb-10 border-b border-gray-100 overflow-x-auto no-scrollbar flex items-center gap-10">
                                {(['about', 'collection', 'reviews', 'gallery'] as const).map((tab) => (
                                    <button
                                        ...
                                        style={fontStyle}
                                    >
                                        {tab === 'about' ? t.tabs.about : 
                                         tab === 'collection' ? t.tabs.products : 
                                         tab === 'reviews' ? t.tabs.reviews : t.tabs.gallery}
                                ...
                                {activeTab === 'about' && (
                                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-12">
                                        <div className="space-y-6">
                                            <h3 className="text-xl font-black text-slate-900 uppercase italic border-l-4 border-orange pl-6" style={fontStyle}>{t.about.vision}</h3>
                                            <p className="text-gray-500 text-lg font-medium leading-relaxed italic pr-4" style={fontStyle}>
                                                "{shop.description}"
                                            </p>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div className="p-8 rounded-[2.5rem] bg-white border border-orange/5 shadow-premium space-y-4">
                                                ...
                                                <h4 className="text-lg font-black text-slate-900 uppercase leading-tight" style={fontStyle}>{t.about.authenticityTitle}</h4>
                                                <p className="text-xs text-gray-400 font-bold leading-relaxed" style={fontStyle}>
                                                    {t.about.authenticityDesc.replace("{city}", shop.city)}
                                                </p>
                                            </div>
                                            <div className="p-8 rounded-[2.5rem] bg-white border border-orange/5 shadow-premium space-y-4">
                                                <div className="w-12 h-12 rounded-2xl bg-orange/10 flex items-center justify-center text-orange">
                                                ...
                                                <h4 className="text-lg font-black text-slate-900 uppercase leading-tight" style={fontStyle}>{t.about.digitalAssistanceTitle}</h4>
                                                <p className="text-xs text-gray-400 font-bold leading-relaxed" style={fontStyle}>
                                                    {t.about.digitalAssistanceDesc.replace("{email}", shop.email || "support@astrologyinbharat.com")}
                                                </p>
                                            </div>
                                        </div>

                                        <div className="space-y-6">
                                             <h3 className="text-xl font-black text-slate-900 uppercase tracking-tight" style={fontStyle}>{t.about.specializations}</h3>
                                             <div className="flex flex-wrap gap-3">
                                                {(shop.features || []).map((f: any, i: number) => (
                                                    <div key={i} className="px-6 py-3 bg-white rounded-2xl border border-orange/10 flex items-center gap-3 shadow-sm hover:border-orange transition-colors">
                                                        ...
                                                        <span className="text-xs font-black text-slate-700 uppercase tracking-widest" style={fontStyle}>{f}</span>
                                                    </div>
                                                ))}
                                             </div>
                                        </div>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                                                    ...
                                                    {(storeProducts as any[]).length === 0 && (
                                                        <div className="col-span-full py-20 text-center space-y-4">
                                                            ...
                                                            <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]" style={fontStyle}>{t.emptyStates.noProducts}</p>
                                                        </div>
                                                    )}
                                                </div>
                                            )}
                                    ...
                                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar" data-lenis-prevent>
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div className="flex flex-col">
                                                            ...
                                                            <span className="text-[10px] font-bold text-gray-400" style={fontStyle}>{t.emptyStates.verifiedJourney}</span>
                                                        </div>
                                                    </div>
                                        ...
                                        {storeReviews.length === 0 && (
                                            <div className="py-20 text-center space-y-4">
                                                ...
                                                <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]" style={fontStyle}>{t.emptyStates.noReviews}</p>
                                            </div>
                                        )}
                                    </div>
                                )}
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                                            ...
                                            {(shop.gallery || []).length === 0 && (
                                                <div className="col-span-full py-20 text-center space-y-4">
                                                    ...
                                                    <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]" style={fontStyle}>{t.emptyStates.noGallery}</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
