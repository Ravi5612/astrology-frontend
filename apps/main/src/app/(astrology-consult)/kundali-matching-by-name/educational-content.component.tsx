...
const EducationalContent = () => {
  ...
  const t = (matchingTranslations[lang as keyof typeof matchingTranslations] || matchingTranslations.en).educational;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <h2 className="text-4xl md:text-6xl font-black text-white leading-none tracking-tight" style={fontStyle}>
                  {t.title1} <span className="text-orange italic">{t.titleHighlight}</span>
                </h2>
                <p className="text-gray-400 font-bold text-lg leading-relaxed max-w-xl italic" style={fontStyle}>
                  {t.quote}
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {t.features.map((item, idx) => (
                  <div key={idx} className="flex items-center gap-4 group">
                    ...
                    <span className="text-xs font-black text-white/90 uppercase tracking-widest" style={fontStyle}>{item.text}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/5 p-10 md:p-14 rounded-[3rem] border border-white/10 backdrop-blur-sm overflow-hidden min-h-[400px] flex flex-col justify-center">
                ...
                <div className="space-y-6 relative z-10">
                  ...
                  <h4 className="text-2xl font-black text-white leading-tight" style={fontStyle}>{t.didYouKnow.title}</h4>
                  <p className="text-gray-400 font-bold leading-relaxed text-sm" style={fontStyle}>
                    {t.didYouKnow.desc}
                  </p>
                  <div className="pt-6 border-t border-white/10 flex items-center gap-4">
                     ...
                     <span className="text-[10px] font-black text-white/50 uppercase tracking-widest" style={fontStyle}>{t.didYouKnow.trusted}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-gray-100 rounded-full border border-gray-200">
               <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none" style={fontStyle}>{t.ashtakoot.badge}</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight" style={fontStyle}>
              {t.ashtakoot.title1} <span className="text-orange">{t.ashtakoot.titleHighlight}</span> {t.ashtakoot.title2}
            </h2>
            <p className="text-gray-400 font-bold text-sm leading-relaxed uppercase tracking-widest" style={fontStyle}>{t.ashtakoot.subtitle}</p>
          </div>
                  ...
                  <div className="relative z-10 space-y-6">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex flex-col items-end">
                        <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1" style={fontStyle}>{t.ashtakoot.impact}</span>
                        <span className="text-xs font-black text-orange uppercase tracking-widest leading-none bg-orange/10 px-2 py-1 rounded-lg" style={fontStyle}>
                    ...
                    <div className="space-y-4">
                      <h4 className="text-xl font-black text-gray-900 uppercase tracking-tight group-hover:text-orange transition-colors" style={fontStyle}>
                        {koot.title}
                      </h4>
                      <p className="text-sm font-bold text-gray-400 leading-relaxed italic" style={fontStyle}>
                        &quot;{koot.desc}&quot;
                      </p>
                    </div>
                  </div>
