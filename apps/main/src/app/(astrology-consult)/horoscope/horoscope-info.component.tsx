    ...
    <section className="relative pt-8 pb-10 md:pt-12 md:pb-16 overflow-hidden bg-fixed bg-cover bg-center text-white" style={{ backgroundImage: "url('/images/cosmic/media__1782216892557.jpg')" }}>
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8 md:mb-12 px-2">
          <h2 className="text-[22px] md:text-3xl lg:text-4xl font-black text-white mb-2.5 md:mb-4">
            What is a <span className="text-[#FF6B00]">Horoscope</span>?
          </h2>
          <p className="text-slate-300 text-[13px] md:text-base leading-relaxed font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-10 md:mb-16">
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/10 shadow-lg hover:-translate-y-1 hover:bg-white/10 transition-all">
            <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-[#FF6B00]/20 flex items-center justify-center text-[#FF6B00] mb-4 md:mb-6 shadow-sm border border-[#FF6B00]/30">
              <FiCompass className="w-6 h-6 md:w-7 md:h-7" />
            </div>
            <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3">Life Guidance</h3>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/10 shadow-lg hover:-translate-y-1 hover:bg-white/10 transition-all">
            ...
            <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3">Self Discovery</h3>
            <p className="text-slate-300 text-xs md:text-sm leading-relaxed font-medium">
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/10 shadow-lg hover:-translate-y-1 hover:bg-white/10 transition-all">
            ...
            <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3">Preparedness</h3>
            <p className="text-slate-300 text-xs md:text-sm leading-relaxed font-medium">
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/10 shadow-lg hover:-translate-y-1 hover:bg-white/10 transition-all">
            ...
            <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3">Better Decisions</h3>
            <p className="text-slate-300 text-xs md:text-sm leading-relaxed font-medium">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-6 md:p-12 border border-white/10 shadow-2xl">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 items-center">
            <div className="w-full lg:w-1/2">
              <h3 className="text-xl md:text-3xl font-black text-white mb-4 md:mb-5">
                Why Read Your Daily Horoscope?
              </h3>
              <div className="space-y-3 md:space-y-4 text-slate-300 leading-relaxed font-medium text-sm md:text-base">
                <p>
                ...
                <p className="font-bold text-[#FF6B00] bg-[#FF6B00]/10 p-3 md:p-4 rounded-xl border border-[#FF6B00]/20 text-xs md:text-sm">
