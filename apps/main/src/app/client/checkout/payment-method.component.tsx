        ...
        <div className="p-8 md:p-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <label
              ...
              } ${balance < total ? "opacity-40 grayscale cursor-not-allowed" : ""}`}
            >
              <input
                type="radio"
                name="payment"
              ...
              <div>
                ...
                <div className="flex flex-col">
                  <span className={`text-[10px] font-black uppercase tracking-[0.2em] ${balance < total ? "text-red-500" : "text-emerald-500"}`}>
