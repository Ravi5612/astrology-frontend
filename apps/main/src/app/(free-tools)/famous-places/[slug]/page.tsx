  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB]">
      ...
      <section className="relative h-[45vh] md:h-[55vh] w-full overflow-hidden bg-brown">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 md:p-8 z-10 w-full">
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2.5 mb-1 opacity-100">
                <div className="flex items-center text-orange bg-black/40 px-2 py-1 rounded-md border border-orange/20 backdrop-blur-sm">
                  <svg className="w-3 h-3 fill-current drop-shadow-md" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                  <span className="text-[11px] font-black ml-1 text-white">
                    {place.rating || "4.8"}
                  </span>
                </div>
                <div className="w-1.5 h-1.5 rounded-full bg-white/80 shadow-[0_1px_2px_rgba(0,0,0,0.8)]"></div>
                <span className="text-[10px] font-bold uppercase tracking-widest text-white/90 drop-shadow-[0_1px_2px_rgba(0,0,0,0.9)]">
                  {t.detail.verifiedSite}
                </span>
              </div>
              <h1 className="text-2xl md:text-4xl font-display font-black leading-tight tracking-tight text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)] max-w-4xl">
                {place.title}
              </h1>
            </div>
          </div>
