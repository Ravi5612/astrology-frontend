            ...
            <div className="flex items-center gap-1.5 md:gap-3 shrink-0">
                ...
                <div className="flex items-center gap-2 md:gap-3">
                    ...
                    <div className="shrink-0">
                        <h1 className="font-bold text-xs md:text-sm leading-none text-white flex items-center gap-1.5">
                            {expertData.name}
                        ...
                        <p className="text-[8px] md:text-[9px] text-white/80 flex items-center gap-1 mt-0.5">
            ...
            <div className="flex items-center gap-1.5 md:gap-8 shrink-0">
                ...
                {sessionStatus === 'active' && (
                    <button
                        ...
                        className="bg-white text-red-600 hover:bg-red-50 px-2 py-1 md:px-4 md:py-2 rounded-full md:rounded-xl font-bold text-[10px] md:text-sm shadow-lg flex items-center justify-center gap-1 md:gap-2 transition-all active:scale-95"
                    >
                        <AlertCircle className="w-3.5 h-3.5 md:w-4 md:h-4" />
                        <span className="text-[10px] md:text-sm font-black">End</span>
                    </button>
                )}
                ...
                <div className="flex items-center gap-0.5 md:gap-1">
                    <button onClick={() => router.push('/')} className="p-1 md:p-1.5 hover:bg-black/10 rounded-xl transition-all active:scale-95 flex flex-col items-center gap-0.5 text-white">
                        <Home className="w-3.5 h-3.5 md:w-4 md:h-4" />
                        <span className="text-[7px] md:text-[8px] font-bold uppercase">Home</span>
                    </button>
                    <button onClick={() => router.push('/client/profile')} className="p-1 md:p-1.5 hover:bg-black/10 rounded-xl transition-all active:scale-95 flex flex-col items-center gap-0.5 text-white">
                        <UserIcon className="w-3.5 h-3.5 md:w-4 md:h-4" />
                        <span className="text-[7px] md:text-[8px] font-bold uppercase">Profile</span>
                    </button>
                    <button
                        onClick={() => setIsDarkMode(!isDarkMode)}
                        className="w-7 h-7 md:w-10 md:h-10 bg-black/20 hover:bg-black/30 rounded-full flex items-center justify-center transition-all active:scale-90 shadow-inner"
                    >
                        {isDarkMode ? <Sun className="w-3.5 h-3.5 md:w-5 md:h-5 text-yellow-400" /> : <Moon className="w-3.5 h-3.5 md:w-5 md:h-5 text-white" />}
                    </button>
                </div>
            </div>
        </header>
