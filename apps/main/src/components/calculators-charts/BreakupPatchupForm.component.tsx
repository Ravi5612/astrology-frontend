...
import { FaUser, FaSpinner, FaArrowRight } from "react-icons/fa";
import { TbCrystalBall } from "react-icons/tb";
import { GiLotus } from "react-icons/gi";
import { BreakupPatchupFormProps } from "@/lib/types/calculator";

const BreakupPatchupForm: React.FC<BreakupPatchupFormProps> = ({
  yourName,
  setYourName,
  partnerName,
  setPartnerName,
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full mt-2 bg-white border-2 border-[#301118]/5 px-6 py-4 text-[#301118] font-bold focus:border-primary outline-none transition-all shadow-sm text-sm"
...
export default BreakupPatchupForm;
