...
interface BreakupPatchupFormProps {
  yourName: string;
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    max={99}
                    style={{ borderRadius: "9999px" }}
                    className="w-full mt-2 bg-white border-2 border-[#301118]/5 px-5 py-3.5 text-[#301118] font-bold focus:border-[#fd6410] outline-none transition-all shadow-sm text-sm"
                    placeholder="e.g. 22"
                    value={yourAge}
