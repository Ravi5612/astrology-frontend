            ...
            <div className="bg-gradient-to-b from-[#fff7f0] to-white rounded-[24px] border border-orange/30 p-6 lg:p-8 h-full shadow-sm transition-all duration-300 hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.15)] hover:border-orange hover:-translate-y-1">
              <div className="flex items-center justify-between border-b border-orange/10 pb-4 mb-6">
                ...
                <div className="flex items-center gap-2">
                  <span className={`w-2 h-2 rounded-full animate-pulse ${astrologer.is_available ? 'bg-green-500' : 'bg-gray-400'}`}></span>
                  <span className={`text-xs font-semibold uppercase tracking-wide ${astrologer.is_available ? 'text-green-600' : 'text-gray-500'}`}>
              ...
              <div className="flex gap-6 border-b border-gray-100 mb-6">
                <button
                  ...
                  className={`font-bold text-[15px] pb-2 px-1 transition-colors relative ${activeTab === 'about' ? 'text-gray-900 border-b-2 border-orange' : 'text-gray-500 hover:text-orange'
                    }`}
                >
                  About
                </button>
                <button
                  ...
                  className={`font-bold text-[15px] pb-2 px-1 transition-colors relative ${activeTab === 'experience' ? 'text-gray-900 border-b-2 border-orange' : 'text-gray-500 hover:text-orange'
                    }`}
                >
                  Experience
                </button>
                <button
                  ...
                  className={`font-bold text-[15px] pb-2 px-1 transition-colors relative ${activeTab === 'reviews' ? 'text-gray-900 border-b-2 border-orange' : 'text-gray-500 hover:text-orange'
                    }`}
                >
                  Reviews
                </button>
                <button
                  ...
                  className={`font-bold text-[15px] pb-2 px-1 transition-colors relative ${activeTab === 'gallery' ? 'text-gray-900 border-b-2 border-orange' : 'text-gray-500 hover:text-orange'
                    }`}
                >
                  Gallery
                </button>
                <button
                  ...
                  className={`font-bold text-[15px] pb-2 px-1 transition-colors relative ${activeTab === 'videos' ? 'text-gray-900 border-b-2 border-orange' : 'text-gray-500 hover:text-orange'
                    }`}
                >
                  Videos
                </button>
                  ...
                  <div className="prose prose-sm max-w-none text-gray-600 leading-relaxed animate-in fade-in slide-in-from-bottom-2 duration-300">
                    {astrologer.bio ? (
                      ...
                      <p>
                        ...
                        <span className="font-semibold text-orange"> {astrologer.expertise}</span>.
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange focus:border-transparent outline-none transition-all"
                ...
                <div>
                  ...
                  <input type="date" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange focus:border-transparent outline-none transition-all" required />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-1">
                    Birth Time <span className="text-red-500">*</span>
                  </label>
                  <input type="time" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange focus:border-transparent outline-none transition-all" required />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-1">
              ...
              <div className="text-right mt-6">
                <button
                  type="submit"
                  className="px-8 py-2.5 bg-orange text-white rounded-lg hover:bg-orange-hover transition-colors font-semibold shadow-md active:scale-95 transform duration-150"
                >
                  Submit
                </button>
              </div>
