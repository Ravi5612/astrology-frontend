            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content text-dark border-0 shadow-lg">
                    <div className="modal-header bg-light border-0 d-flex justify-content-between align-items-center w-100">
                        <h5 className="modal-title font-bold">{t.expertSection.filterTitle}</h5>
                        <button
                            type="button"
                    ...
                    <div className="modal-body p-4 custom-scrollbar" style={{ maxHeight: "70vh", overflowY: "auto" }}>
                        ...
                        <div className="mb-4 flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-bold text-gray-700">{t.expertSection.filterLabels.showOnlineOnly}</span>
                            </div>
                        ...
                        {/* 3. Sort Order */}
                        <div className="mb-4">
                            <label className="form-label font-bold text-gray-700 mb-2 block">{t.expertSection.sortByTitle}</label>
                            <select
                        ...
                        {/* 4. Rating Filter */}
                        <div className="mb-4">
                            <label className="form-label font-bold text-gray-700 mb-2 block">{t.expertSection.filterLabels.minRating}</label>
                            <div className="flex gap-2">
                                {[0, 3, 4, 5].map((rating) => (
                                    ...
                                    >
                                        {rating === 0 ? t.expertSection.filterLabels.any : <><i className="fa-solid fa-star text-xs mr-1" />{rating}+</>}
                                    </button>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="mb-4">
                            <div className="d-flex justify-content-between mb-2">
                                <label className="form-label font-bold text-gray-700">{t.expertSection.filterLabels.priceRange}</label>
                                <span className="px-3 py-1 rounded-full font-bold text-sm shadow-sm bg-primary text-white">
                                    {t.expertSection.filterLabels.upTo} ₹{localFilter.maxPrice}{t.expertSection.filterLabels.perMin}
                                </span>
                            </div>
                            <input
                                type="range"
                            ...
                            <div className="d-flex justify-content-between text-xs mt-2 font-medium">
                                ...
                                >
                                    {t.expertSection.filterLabels.anyPrice}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-2">
                            <div>
                                <label className="form-label font-bold text-gray-700 text-sm">{t.expertSection.filterLabels.language}</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="form-label font-bold text-gray-700 text-sm">{t.expertSection.filterLabels.state}</label>
                                <input
                                    type="text"
                                    className="form-control form-control-sm border-gray-200"
