...
const QuotesLoaderStyles: React.FC = () => {
  return (
    <style jsx global>{`
      .quotes-loader-overlay {
        ...
        width: 100vw;
        height: 100vh;
        background: linear-gradient(135deg, #1a0b2e 0%, #2d1b4e 40%, #4a2c6d 100%);
        z-index: 9999;
        display: flex;
      ...
      .quotes-loader-overlay::before {
        ...
        background:
          ...
          radial-gradient(circle at 80% 50%, rgba(123, 63, 242, 0.15) 0%, transparent 50%);
      ...
      .quotes-loader-overlay::after {
        ...
        background-image:
          ...
          radial-gradient(2px 2px at 60% 70%, rgba(255, 200, 124, 0.3), transparent),
          radial-gradient(1px 1px at 50% 50%, rgba(123, 63, 242, 0.3), transparent),
          radial-gradient(1px 1px at 80% 10%, rgba(255, 140, 0, 0.3), transparent),
          radial-gradient(2px 2px at 90% 60%, rgba(245, 166, 35, 0.3), transparent);
      ...
      .quote-container {
        ...
        border-radius: 28px;
        box-shadow: 0 25px 70px rgba(0, 0, 0, 0.5), 0 10px 30px rgba(255, 140, 0, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.9);
      ...
      .quote-icon-wrapper i {
        font-size: 4rem;
        background: linear-gradient(135deg, #ff8c00 0%, #ffa500 50%, #f5a623 100%);
      ...
      @keyframes iconGlowPulse {
        0%, 100% { transform: scale(1); filter: drop-shadow(0 4px 12px rgba(255, 140, 0, 0.4)); }
        50% { transform: scale(1.05); filter: drop-shadow(0 6px 20px rgba(255, 140, 0, 0.6)); }
      }
      ...
      @media (max-width: 768px) {
        .quote-container { padding: 2.5rem 1.75rem; margin: 0 1rem; border-radius: 24px; }
        .quote-text { font-size: 1.4rem; padding: 0 0.5rem; }
        .quote-text::before, .quote-text::after { font-size: 3rem; }
        .quote-author { font-size: 1.1rem; }
        .quote-source { font-size: 0.9rem; }
        .quote-icon-wrapper i { font-size: 3rem; }
        .loading-spinner { width: 60px; height: 60px; border-width: 5px; }
        .loading-text { font-size: 1.1rem; }
      }

      @media (prefers-reduced-motion: reduce) {
        .quotes-loader-overlay, .quote-container, .quote-text, .quote-author, .quote-source, .quote-icon-wrapper i, .loading-spinner {
...
export default QuotesLoaderStyles;
