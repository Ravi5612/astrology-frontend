            ...
            <div className="lg:col-span-8 flex flex-wrap justify-between gap-10 md:gap-8">
              ...
              <div className="flex-1 min-w-[160px]">
                ...
                <ul className="flex flex-col gap-2.5 pl-0">
                  ...
                  <li><a href="/our-experts" className="text-[14px] text-[#f3f3f3] hover:text-[#ff6b00] transition-colors no-underline flex items-center gap-2 group"><i className="fa-solid fa-angle-right text-[#ff6b00] text-[10px] transform group-hover:translate-x-1 transition-transform" />{t.talkToExpert}</a></li>
              ...
              <div className="flex-1 min-w-[160px]">
                ...
                <ul className="flex flex-col gap-2.5 pl-0">
                  <li><a href="#" className="text-[14px] text-[#f3f3f3] hover:text-[#ff6b00] transition-colors no-underline flex items-center gap-2 group"><i className="fa-solid fa-angle-right text-[#ff6b00] text-[10px] transform group-hover:translate-x-1 transition-transform" />{t.expertLogin}</a></li>
                  <li><a href="#" className="text-[14px] text-[#f3f3f3] hover:text-[#ff6b00] transition-colors no-underline flex items-center gap-2 group"><i className="fa-solid fa-angle-right text-[#ff6b00] text-[10px] transform group-hover:translate-x-1 transition-transform" />{t.expertRegistration}</a></li>
                  <li><Link href={PATHS.HINDU_CALENDAR} className="text-[14px] text-[#f3f3f3] hover:text-[#ff6b00] transition-colors no-underline flex items-center gap-2 group"><i className="fa-solid fa-angle-right text-[#ff6b00] text-[10px] transform group-hover:translate-x-1 transition-transform" />{t.shubhMuhurat}</Link></li>
